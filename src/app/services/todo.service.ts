...
export class TodoService {
  ...
  getTodoItems(): TodoItem[] {
    const data = this.appLocalData.getItem(this.TODO_ITEMS_KEY);
  ...
  saveTodoItems(items: TodoItem[]): void {
    ...
    this.appLocalData.setItem(this.TODO_ITEMS_KEY, JSON.stringify(cleanedItems));
  }

  clearTodoItems(): void {
    this.appLocalData.removeItem(this.TODO_ITEMS_KEY);
